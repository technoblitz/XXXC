...
int64_t nStakeCombineThreshold = 5 * COIN;
...
// XXXBTC: total coins staked (non-spendable until maturity)
...
// XXXBTC: get current stake weight
...
// XXXBTC: check 'spent' consistency between wallet and txindex
// XXXBTC: fix wallet spent state according to txindex
...
// XXXBTC: disable transaction (only for coinstake)
